...
public:
	...
	void render(HDC hdc, int destX, int destY, int sourX, int sourY, int sourWidth, int sourHeight, int scale);
	...
	void scaleRender(HDC hdc, int destX, int destY, float scale);
	void frameRender(HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY);
	void scaleFrameRender(HDC hdc, int destX, int destY,int scale);
	void alphaRender(HDC hdc, BYTE alpha);
	void alphaRender(HDC hdc, int destX, int destY, BYTE alpha);
	void alphaRender(HDC hdc, int destX, int destY, int sourX, int sourY, int sourWidth, int sourHeight, BYTE alpha);
	void alphaScaleFrameRender(HDC hdc, int destX, int destY,float scale, BYTE alpha);
	void alphaScaleRender(HDC hdc, int destX, int destY, float scale, BYTE alpha);
	void aniRender(HDC hdc, int destX, int destY, animation* ani,float scale);
